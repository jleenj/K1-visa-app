...
const Section1_9 = ({ currentData = {}, updateField, onBlock }) => {
  ...
  // Notify parent component about blocking status
  useEffect(() => {
    if (onBlock) {
      onBlock(hasAnyYesAnswer);
    }
  }, [hasAnyYesAnswer, onBlock]);
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">
            Criminal History & Legal Background
          </h3>
