...
Please contact our support team for further assistance.`;
  ...
  // Disable Next button if required questions aren't answered
  const isNextDisabled = hasPreviousPetitions === null || hasChildrenUnder18 === null;
        ...
        <div className={`space-y-4 border-t pt-8 ${needsIMBRAWaiver ? 'opacity-50 pointer-events-none' : ''}`}>
          ...
          {hasOtherObligations === 'yes' && (
            <div className="mt-8 space-y-4">
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                <p className="text-sm font-semibold text-gray-900 mb-2">
                  How many people are you still financially obligated to support (not including anyone listed above)? <span className="text-red-500">*</span>
                </p>
              </div>
